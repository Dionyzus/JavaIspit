	...
	public static void sendMail(double price) {
        ...
        Session session = Session.getDefaultInstance(props,
                    new javax.mail.Authenticator() {
                         ...
                         {
                               return new PasswordAuthentication("dionyzus7776@gmail.com", "vbtlrkfqrjirpyip");
                         }
                    });
        ...
        try {
              ...
              message.setFrom(new InternetAddress("dionyzus7776@gmail.com"));

              Address[] toUser = InternetAddress 
                         .parse("testni.racun75@gmail.com");  
